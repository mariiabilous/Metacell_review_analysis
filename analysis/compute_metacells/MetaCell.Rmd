...
```{r}
genes <- intersect(intersect(MC.all.markers.df$gene, sc.all.markers$gene), MC.seurat.all.markers$gene)
plot(x = MC.all.markers.df[genes, ]$logFC, y = sc.all.markers[genes, ]$avg_log2FC)
abline(a = 0, b =1)

#genes <- intersect(MC.all.markers.df$gene, MC.seurat.all.markers$gene)
plot(x = MC.seurat.all.markers[genes, ]$logFC, y = sc.all.markers[genes, ]$avg_log2FC)
abline(a = 0, b =1)
```
